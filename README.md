...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wh6wn9w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wh6wn9w.containers.anotherwebservice.com/
...
```
git clone git@github.com:insert0name/container-wh6wn9w.git
cd container-wh6wn9w
```
...
```
docker attach container-wh6wn9w
```
